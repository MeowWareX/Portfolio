...
if (! empty($_POST['email'])) {
	...
	$receiver_email = 'meowwaredev@gmail.com';
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if ($enable_smtp == 'no') { // Simple Email
			...
			$mail->SMTPAuth = true;
			$mail->Username = 'meowwaredev@gmail.com';
			$mail->Password = 'ciwhzmbjeqvqelhc'; // Your Password
			$mail->SMTPSecure = 'TLS'; // Your Secure Connection
			$mail->Port = 587; // Your Port
			$mail->setFrom($fields['Email'], $fields['Name']);

			// // Habilitar debug
			// $mail->SMTPDebug = 3; // Nivel de debug (0 = apagado, 1 = mensajes, 2 = mensajes y datos, 3 = mensajes detallados)

			// // Usar la salida de PHP para ver el debug
